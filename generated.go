...
func UnmarshalNewTodo(v interface{}) (NewTodo, error) {
	...
	for k, v := range asMap {
		...
		case "user1":
			var err error
			it.User1, err = UnmarshalUserReq(v)
			if err != nil {
				return it, err
			}
		case "user2":
		...
		case "todo":
			var err error
			it.Todo, err = UnmarshalTodoReq(v)
			if err != nil {
				return it, err
			}
		}
...
func UnmarshalTodoReq(v interface{}) (TodoReq, error) {
	var it TodoReq
	var asMap = v.(map[string]interface{})

	for k, v := range asMap {
		switch k {
		case "notRequiredTodo":
			var err error
			var ptr1 string
			if v != nil {
				ptr1, err = graphql.UnmarshalString(v)
				it.NotRequiredTodo = &ptr1
			}
		...
		case "requiredTodo":
			var err error
			it.RequiredTodo, err = graphql.UnmarshalString(v)
			if err != nil {
				return it, err
			}
		}
...
func UnmarshalUserReq(v interface{}) (UserReq, error) {
	var it UserReq
	var asMap = v.(map[string]interface{})
	...
	for k, v := range asMap {
		...
		case "requiredUser":
			var err error
			it.RequiredUser, err = graphql.UnmarshalString(v)
			if err != nil {
				return it, err
			}
		case "notRequiredUser":
			var err error
			var ptr1 string
			if v != nil {
				ptr1, err = graphql.UnmarshalString(v)
				it.NotRequiredUser = &ptr1
			}
